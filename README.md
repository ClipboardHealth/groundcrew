...
- [Hook-generated paths](./docs/setup-hooks.md#hookgeneratedpaths-when-the-hook-dirties-the-worktree): `crew.config.ts` `hookGeneratedPaths` keeps a `prepareWorktree` hook's own output from blocking worktree teardown.
