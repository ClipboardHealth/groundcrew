...
Lid-close sleep is enforced at the hardware level and cannot be prevented in userspace. For lid-closed remote access, use clamshell mode with external power, display, and input.
