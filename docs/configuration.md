...
- `agent-claude`, `agent-codex`, `agent-cursor`, `agent-<name>` routes to that enabled agent.
...
Groundcrew ships built-in presets for `claude`, `codex`, and `cursor`, but agents are not enabled by default. List the agents you want in `agents.definitions`:
...
To keep all shipped presets enabled:
...
| `agents.definitions`                     | **required**         | Enabled agent set. Built-in keys (`claude`, `codex`, `cursor`) can use `{}` to opt into the shipped preset. Custom agent names must provide `cmd` and `color`.                                                                                                                                                                                                                                                                                                                                                              |
