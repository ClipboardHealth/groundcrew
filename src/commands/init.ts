...
const INIT_USAGE =
  "Usage: crew init [--global | --local] [--force] [--dry-run] [--project-dir <dir>] [--repo <owner/repo>]... [--runner <auto|safehouse|sdx|none>] [--agent <claude|codex|cursor|grok|pi>]";
...
export const INIT_AGENTS = ["claude", "codex", "cursor", "grok", "pi"] as const;
