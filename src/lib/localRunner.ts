 ...
 * are the deny-first paths for their platform. `none` and the explicit names
 * pass through unchanged so users always get exactly what they asked for.
 * Pure: takes everything it needs as arguments so the dispatcher can test
 * platform pivots without touching real hosts.
 */
